...
public class TestDateTimeFormat extends TestCase {
    ...
    public void test_fix_issues_86_correctly_parses_plus_in_front_of_year_for_yyyyMMdd() {
        // Given: an expected pattern like 20130109
        ...
        // When: I create a Formatter
        final DateTimeFormatter formatter = DateTimeFormat.forPattern(pattern);
        // And:  I try to parse this date
        final DateTime result = formatter.parseDateTime(dateTime);
    ...
    public void test_fix_issues_86_correctly_parses_plus_in_front_of_year_for_MMyyydd() {
        ...
        // And: a date that includes + per the ISO8601 spec of allowing it for 5 digit years
        final String dateTime = "01+201309";
        // When: I create a Formatter
        final DateTimeFormatter formatter = DateTimeFormat.forPattern(pattern);
        // And:  I try to parse this date
        final DateTime result = formatter.parseDateTime(dateTime);
    ...
    public void test_fix_issues_86_correctly_parses_plus_in_front_of_year_for_MM_yyyy_dd() {
        // Given: an expected pattern like 01-2013-09
        final String pattern = "MM-yyyy-dd";
        // And: a date that includes + per the ISO8601 spec of allowing it for 5 digit years
        final String dateTime = "01-+2013-09";
        // When: I create a Formatter
        final DateTimeFormatter formatter = DateTimeFormat.forPattern(pattern);
        // And:  I try to parse this date
        final DateTime result = formatter.parseDateTime(dateTime);
    ...
    public void test_fix_issues_86_correctly_parses_plus_in_front_of_year_for_yyyydd() {
        // Given: an expected pattern like 201309
        final String pattern = "yyyydd";
        // And: a date that includes + per the ISO8601 spec of allowing it for 5 digit years
        final String dateTime = "+201309";
        // When: I create a Formatter
        final DateTimeFormatter formatter = DateTimeFormat.forPattern(pattern);
        // And:  I try to parse this date
        final DateTime result = formatter.parseDateTime(dateTime);
